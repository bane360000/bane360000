...
I am a computer science graduate with second class (upper) honors, with a master's degree in view (M.sc Computer Information Technology), and a certified google digital marketer with a specialty in SEO with 3 years of experience working with Fiverr as a seller. I just started making inroads with my theoretical knowledge in the software development industry. I am currently learning the front-end stack(HTML>HTML5>CSS>CSS3>Javascript>React). I will be open and enthusiastic about working on projects around the mentioned front-end technologies.
